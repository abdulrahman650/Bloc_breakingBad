...
import 'package:untitled3/constans/my_colors.dart';
import 'package:untitled3/presentation/widgets/character_item.dart';
...
class _CharactersScreenState extends State<CharactersScreen> {
  ...
  List<Widget> _buildAppBarActios(){
    if(_isSearching){
      return[
    ...
    return BlocBuilder<CharactersCubit, CharactersState>(
      builder: (context, state) {
        if (state is CharactersLoaded) {
          ...
          return showLoadingIndecatoir();
        }
      },
    );
  }

  Widget showLoadingIndecatoir() {
    return Center(
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          children: [
            SizedBox(height: 20,),
            Text('Cant/t connect .. check Internet',style: TextStyle(fontSize: 22,color: MyColors.myGrey,
            ),
            ),
